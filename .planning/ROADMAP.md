...
- [x] 03-03-PLAN.md — Side panel editor with CodeMirror 6 Edit/Preview/Split + metadata + editable title/status/type (EDIT-10..EDIT-12) — Wave 2 — pending UAT (Tasks 6 & 7)
...
- [x] 03-04b-PLAN.md — Autosave wiring + save-state UI: triple-timer debounce + SaveIndicator + SaveFailureModal + Warning-8 snapshots (EDIT-13 debounce, EDIT-15) — Wave 2 — pending UAT (Tasks 4 & 5)
