...
> **Heads-up (v0.8.3):** these npm packages are **not published yet**. They go out
...
> app anyway, e.g. `@roadraven/mcp@0.8.3` — the app warns when the MCP server and
...
runs `npx -y @roadraven/mcp@0.8.3`, and `@roadraven/mcp` isn't
