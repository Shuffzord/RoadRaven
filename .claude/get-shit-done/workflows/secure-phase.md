...
```
Agent(
  prompt="Read C:/Work/RoadRaven/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Work/RoadRaven/.claude/get-shit-done/templates/SECURITY.md`
