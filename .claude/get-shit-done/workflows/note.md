...
- **Global scope**: `/home/shuffler/Work/Roadraven/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/shuffler/Work/Roadraven/.claude/notes/`)
...
2. Glob `/home/shuffler/Work/Roadraven/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/shuffler/Work/Roadraven/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/shuffler/Work/Roadraven/.claude/notes/` — works in any directory
