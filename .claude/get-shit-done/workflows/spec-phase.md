...
```bash
INIT=$(node "C:/Work/RoadRaven/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Work/RoadRaven/.claude/get-shit-done/templates/spec.md.
