...
<reference>
@/home/shuffler/Work/Roadraven/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/shuffler/Work/Roadraven/.claude/get-shit-done/references/user-profiling.md` to load:
