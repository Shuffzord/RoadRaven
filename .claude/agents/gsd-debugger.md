...
<required_reading>
@C:/Work/RoadRaven/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Work/RoadRaven/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Work/RoadRaven/.claude
                  → checks C:/Work/RoadRaven/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Work/RoadRaven/.claude/get-shit-done
                  → writes to C:/Work/RoadRaven/.claude/get-shit-done/hooks/
...
@C:/Work/RoadRaven/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Work/RoadRaven/.claude/get-shit-done/references/common-bug-patterns.md
