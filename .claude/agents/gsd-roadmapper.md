...
Reference full template: `/home/shuffler/Work/Roadraven/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/shuffler/Work/Roadraven/.claude/get-shit-done/templates/state.md`.
