...
Reference full template: `C:/Work/RoadRaven/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Work/RoadRaven/.claude/get-shit-done/templates/state.md`.
