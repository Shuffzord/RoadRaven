...
```markdown
Read C:/Work/RoadRaven/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Work/RoadRaven/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Work/RoadRaven/.claude/agents/gsd-ui-checker.md for instructions.
