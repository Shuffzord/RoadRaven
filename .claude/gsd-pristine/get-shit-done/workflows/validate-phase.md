...
```
Task(
  prompt="Read C:/Work/RoadRaven/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Work/RoadRaven/.claude/get-shit-done/templates/VALIDATION.md`
