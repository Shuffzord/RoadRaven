...
<reference>
@C:/Work/RoadRaven/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Work/RoadRaven/.claude/get-shit-done/references/user-profiling.md` to load:
